...
const Growth = () => {
  return (
      ...
      <div>
        ...
        <p className="text-xl xs:text-2xl md:text-4xl text-center mb-5">GROWTH OF CLIENTS</p>
      ...
      <div className="grid md:grid-cols-2 justify-around gap-4 mt-10">
        <div className="grid gap-10 md:gap-4 justify-center">
          <div>
            <p className="text-lg xs:text-xl">INVESTMENT</p>
            <p>
          ...
          <div>
            <p className="text-lg xs:text-xl">LOANS</p>
            <p>
              Qui dolore ipsum quia dolor sit amet, consectetur adipisci velit,
              sed quia non numquam eius modi tempora incidunt lores ta porro
              ame.
          ...
          <div>
            <p className="text-lg xs:text-xl">BUSINESS ADVICE</p>
            <p>
              Qui dolore ipsum quia dolor sit amet, consectetur adipisci velit,
              sed quia non numquam eius modi tempora incidunt lores ta porro
              ame.
        ...
        <div>
            <p className="text-lg xs:text-xl">PROGRESS</p>
            <p>
              Qui dolore ipsum quia dolor sit amet, consectetur adipisci velit,
              sed quia non numquam eius modi tempora incidunt lores ta porro
              ame.
