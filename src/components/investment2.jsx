...
const investment2 = () => {
  return (
    <section className="relative">
      <section className="grid md:grid-rows-3 md:grid-flow-col md:absolute lg:right-80 top-[650px] h-[650px]">
          ...
          <div className="flex flex-col justify-center md:row-span-2 md:col-span-2 bg-[#f7f7f7f7] py-10 px-8 order-3 md:order-1">
            <h1 className="text-2xl">WE HELP YOU TRACK YOUR INVESTMENT PERFORMANCE</h1>
          ...
          <h1 className="mt-16 text-2xl md:w-60">TRACK YOUR INVESTMENT WITH OUR EXPERTS</h1>
